package Projects.P04_okulYönetimi.ogrcOgrtYonetimi.ogrcOgrtYonetimi01;
...
public class Islemler {
    ...
    */
    public static void girisPaneli() {
        ...
        switch (secim) { // çıkış haricinde diğerlerine break yazmaya gerek yok
            case "1":
                kisiTuru = "OGRENCI";
                islemMenusu();
                break;
    ...
    public static void islemMenusu() {
        ...
        switch (secilenIslem) { // burda break lere gerek yok
            case 1:
                ekle();
                islemMenusu();
                break;
    ...
    private static void listele() {
        ...
        if (kisiTuru.equalsIgnoreCase("OGRENCI")){//ogrenci listeleme if
            ...
            for (Kisi k: ogrtListesi) {
                System.out.println(k.toString()+" adı soyadı : "+k.getAdSoyad()+k.getYas()); // Adı soyadı kısmı gereksiz
                                                                                            //zaten toString le yazdırıyoruz
            }
    ...
    private static void arama() {
        ...
        boolean flag = true;//flag bayrak olsun true->bayrak havada false->bayrak yerde
        //AHAN Da  TRICK : flag iki farklı method'da da kullanıldıgı icin static yapmak daha clean code olur....
