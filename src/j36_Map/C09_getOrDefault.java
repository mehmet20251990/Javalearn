...
public class C09_getOrDefault {
    public static void main(String[] args) {
        ...
        System.out.println("hm = " + hm);//{Acer=null, Saturn=300 Euro, Ebay=234 Euro, Apple store=333 Euro, MediaMarkt=183 Euro, Amazon=296 Euro, Vatan=111 Euro}
        ...
        System.out.println("hm.getOrDefault(\"Acer\", \"100 Euro\") = " + hm.getOrDefault("Acer", "100 Euro")); //null
        //Ebay key map'de varoldugu için Acer key'e ait value:null return edildi. Null olsa dahi update yapmadı değer değişmez...
        System.out.println("hm = " + hm);//{Acer=null, Saturn=300 Euro, Ebay=234 Euro, Apple store=333 Euro, MediaMarkt=183 Euro, Amazon=296 Euro, Vatan=111 Euro}
    }
}
