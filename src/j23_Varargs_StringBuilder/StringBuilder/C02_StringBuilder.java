...
public class C02_StringBuilder {
    public static void main(String[] args) {
        ...
        // 1.Yol
        StringBuilder sb1 = new StringBuilder(); // default capacity 16 bit olan value.si olmayan boş sb

        System.out.println("sb1.length() = " + sb1.length()); // 0 -> sb deki karakter sysnı return eder
        ...
        System.out.println("sb1 = " + sb1); // JAVATAR selam olsun 24true
        System.out.println("sb1.capacity() = " + sb1.capacity()); // 34 (ESKİ capacityi 2 ile çarpıp 2 ekleyerek yükseltti)
                                                                    // (capacity 10 olsaydı yenisi 22 olacaktı...!!!)
        ...
        //Belirli aralıktaki character'leri alma (sadece burda yazdırma haricinde sb1'de değişiklik görülmez...)

        System.out.println("sb1.subSequence(3,13) = " + sb1.subSequence(3, 13));//3.4.5...12 index karakterleri->ATAR selam
        System.out.println("sb1.substring(17) = " + sb1.substring(17));//17.18... - 17 ve sona kadar tüm karakterler
                                                                            // ->un 24 true basarı gayrete asıktır :)
     ...
     Ayni olan karakterler icin bir sey return etmezken, farkli olan ilk karakter icin ascii tablosuna gore
     kac deger geride veya ileride oldugunu print eder. Tamamen ayni ise bize 0 return eder.
