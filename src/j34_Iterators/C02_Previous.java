...
public class C02_Previous {
    ...
    // l1 elemanlarını tersten print ediniz
     ...
     //   System.out.println(l1);
        /*
        tekrarda son elemandan başlayan işlemler için pointer en sona götürülmeli. bunun için pointer'ı sona götüren
        hasNext() meth çalışmalı
         */
        ListIterator<Integer>it1= l1.listIterator();
        while (it1.hasNext()){ // pointer baştan sona doğru ilerler
            it1.next();
        }
        while (it1.hasPrevious()) { // pointer sondan başa doğru ilerler. Bunun için önce pointerın sona gelmesi gerekir.
            System.out.print(it1.previous()+" "); //23 27 7 11 9 65 38 24
        }

        System.out.println();
        List<String> l2= new ArrayList<String>(Arrays.asList("cagla","ugur","muharrem","cebrail"));
        ...
        while (it2.hasNext()){ // pointer baştan sona doğru ilerler
            String s = it2.next();
