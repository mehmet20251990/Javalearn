...
public class C04_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        DateTimeFormatter dtf1 = DateTimeFormatter.ofPattern("dd:)MMMM:)YYYY"); // 25:)Ekim:)2022
        DateTimeFormatter dtf2 = DateTimeFormatter.ofPattern("hh:mm:ss a"); // 11:22:47 ÖS (am,pm otomatik tanımlanır)
