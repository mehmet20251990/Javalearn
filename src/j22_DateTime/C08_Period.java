...
public class C08_Period {
    public static void main(String[] args) {
        ...
        System.out.println("fark = " + fark);//fark = P-29Y-5M-8D
        ...
        Period periodX = Period.ofDays(1);//1 günde bir tekrarlanan period
        ...
        System.out.println("bugun = " + bugun);
        // task-> 5.9.2022 de başlayan kurs 9 ay olduguna göre bitiş tarihini print eden code create ediniz
