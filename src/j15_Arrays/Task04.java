...
public class Task04 {
    public static void main(String[] args) {
        // task-> girilen int array elamanlarından ortlamadan buyuk olan eleman sayısını print eden code create ediniz
        ...
        System.out.println("array elamlarından ortlamayı geçen eleman sayısı :"+ortlamayıGecenElemnSayısı);
    }
}