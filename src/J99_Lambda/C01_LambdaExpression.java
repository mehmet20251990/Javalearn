...
/*
    ...
    */
    ...
    sayi. // aksiyona girecek list coll.
            stream(). // List elemanlarını yukarıdan aşağıya akışa alır
            forEach(System.out::print);//Meth. reference-> System.out yapısından print meth call edildi.
    ...
    sayi.stream().forEach((C01_LambdaExpression::yazdir));//Method refernece->System.out yapısından print meth call edildi
